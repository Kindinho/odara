    ...
    <div class="novoMenu">
        ...
        <div class="container">
            ...
            <div class="corpo-categorias ver-produto">
                <div class="linha">
                    <div class="col-2">
                        <img src="img/incenso.webp" alt="Produto Imagem">

                        <div class="img-linha">
                            <div class="img-col">
                                <img src="img/incenso.webp" alt="Produto Miniatura">
                            </div>
                            <div class="img-col">
                                <img src="img/incenso2.PNG" alt="Produto Miniatura">
                            </div>
                            <div class="img-col">
                                <img src="img/incenso3.PNG" alt="Produto Miniatura">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-2">
                        <p>Incenso</p>
                        <h4>R$ 13</h4>
                        <form id="product-form" data-product-id="7" data-product-name="Incenso" data-product-price="13" data-product-image="img/incenso2.PNG">
                            <select name="modelo" id="modelo">
                                <option value="Serenidade de Lavanda">Serenidade de Lavanda</option>
                                <option value="Misticismo de Sândalo">Misticismo de Sândalo</option>
                                <option value="Aura de Eucalipto">Aura de Eucalipto</option>
                                <option value="Essência de Jasmim">Essência de Jasmim</option>
                                <option value="Harmonia de Canela">Harmonia de Canela</option>
                            </select>
                        ...
                        <h3>Descrição</h3>
                        <p>O incenso, quando queimado, libera fragrâncias relaxantes e purificadoras. Utilizado há milênios em rituais e meditação, ele ajuda a criar ambientes tranquilos, reduzindo o estresse e promovendo o bem-estar. Disponível em várias formas, o incenso continua a ser um elemento essencial para harmonizar espaços.</p>
                    </div>
                </div>
            </div>
